...
Namsinh int,
Quequan char(30),
foreign key makhoa (Makhoa) references TBLKhoa(Makhoa));
...
Magv int,
KetQua decimal(5,2),
foreign key detai (Madt) references TBLDeTai(Madt),
foreign key giangvien (Magv) references TBLGiangVien(Magv));
